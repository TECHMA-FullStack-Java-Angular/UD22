...
public class Connector {
	...
	public static boolean insert(String dbName, String tableName, String columns, String values) {
		try {
			...
			JOptionPane.showMessageDialog(null, "Error insertando datos en la tabla: "+ex.getMessage());
			return false;
		}
	}
	...
	// Delete 
	public static boolean delete(String db, String table_name, String column, String value) {
		try {
			String queryDb = "USE " + db + ";";
	        Statement stdb = conexion.createStatement();
	        stdb.executeUpdate(queryDb);
	...
	// Delete 
	public static boolean update(String db, String table_name, String column, String value, String changes) {
		try {
			String queryDb = "USE " + db + ";";
	        Statement stdb = conexion.createStatement();
	        stdb.executeUpdate(queryDb);
